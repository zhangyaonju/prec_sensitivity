...
ncin<-nc_open(paste0("./analysis/DLM_GIMMS/",nvar,ind,".DLM.CRU.",scenario,".nc"))
...
ndvi_sens_mean_trend<-parApply(cl,y_pre_ndvi[,,121:300],c(1,2),get_mean_trend)
prec_sens_mean_trend<-parApply(cl,y_prec_12[,,121:300],c(1,2),get_mean_trend)

save(ndvi_sens_mean_trend,prec_sens_mean_trend,file=paste0("./analysis/DLM_GIMMS/",nvar,ind,"_CRU_coef_sensi_mean_trend_",scenario,".RData"))
